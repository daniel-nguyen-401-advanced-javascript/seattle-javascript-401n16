...
// Reliable, repeatable input cannot be guaranteed.
function canRide(height) {
    // This makes for an impure function because it relies on a mutable (re-assignable) variable defined outside of itself.
    return height >= heightRequirement;

    // This would make it a pure function, because it uses an internally defined constant, guaranteeing consistent returns
    // return height >= 46;
}
